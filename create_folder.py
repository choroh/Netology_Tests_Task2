"""
Код создает на Яндекс диске папку. Для проверки работы тестирования
"""
...
class YaUploader:
    ...
    def create_folder(self):
        """
        Фуекция принимает имя папки и создает ее на Яндекс-диске
        :param folder_name:
        :return:
        """
        #self.folder_name = folder_name
...
def outh():
    """
    Функция получает из файла токен Яндекса
    :return:
    """
